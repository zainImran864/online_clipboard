...
const LINUX_DISTROS: LinuxDistro[] = [
    {
        ...
        installCmd: 'sudo dnf install ./pasteport-1.0.1.rpm',
        uninstallCmd: 'sudo dnf remove pasteport',
        filename: 'pasteport-1.0.1.rpm',
    },
    {
        id: 'opensuse',
        ...
        installCmd: 'sudo zypper install ./pasteport-1.0.1.rpm',
    ...
    },
    {
        ...
        installCmd: 'sudo apt install ./pasteport-1.0.1.deb',
        uninstallCmd: 'sudo apt remove pasteport',
        filename: 'pasteport-1.0.1.deb',
    },
    {
        id: 'arch',
        ...
        installCmd: 'sudo pacman -U ./pasteport-1.0.1.pkg.tar.zst',
        uninstallCmd: 'sudo pacman -R pasteport',
        filename: 'pasteport-1.0.1.pkg.tar.zst',
    },
    {
        id: 'appimage',
        ...
        installCmd: 'chmod +x Pasteport-1.0.1.AppImage && ./Pasteport-1.0.1.AppImage',
        uninstallCmd: 'rm -f ./Pasteport-1.0.1.AppImage',
        filename: 'Pasteport-1.0.1.AppImage',
    },
];
...
const PLATFORMS = [
    {
        ...
        name: 'Windows',
        icon: '🪟',
        version: 'v1.0.1 (64-bit)',
        badge: 'Installer + Portable',
        filename: 'Pasteport-Setup-1.0.1.exe',
    ...
    },
    {
        ...
        name: 'macOS',
        icon: '🍎',
        version: 'v1.0.1 Universal',
        badge: 'Apple Silicon & Intel',
        filename: 'Pasteport-1.0.1.dmg',
    ...
    },
    {
        ...
        name: 'Linux',
        icon: '🐧',
        version: 'v1.0.1 (.rpm, .deb, AppImage)',
        ...
        installCmd: 'sudo dnf install ./pasteport-1.0.1.rpm  # or: sudo zypper install ./pasteport-1.0.1.rpm',
